    ...
    >
      <div className="row">
        <div className="col-12  col-xl-6 col-lg-6 col-md-6 col-sm-12  p-5 d-flex justify-content-center align-items-center">
          <div
            className=" d-flex justify-content-center align-items-center flex-column border-0 "
            style={{ width: "70%", backgroundColor: "#F2F2F7" }}
          >
            <div className="">
        ...
        <div className="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12  ">
          <div className="card">
            <iframe
              ...
              src={`https://www.youtube.com/embed/${state?.youTubeVideo}`}
            ></iframe>
          </div>
        </div>
      </div>
