...
const Experts = () => {
  ...
  const getExperts = () => {
    setLoading(true);
    instance
      .get("/api/v1/employee/list?type=EXPERT&size=10&page=0")
      .then((res) => {
      ...
      <div className="">
        <div className="container-fluid">
          <div className="bg-expertbg md:h-[540px] md:p-0 p-10 flex flex-col justify-center items-center text-center">
            <p className="text-base font-semibold text-systemblue leading-[22px]">
              {t("expert")}
            </p>
            <h1 className="font-bold text-[44px] leading-[56px] tracking-tight">
              {t("attention")}
            </h1>
            <p className="md:w-[768px] font-normal text-xl leading-[27px] ">
              {t("expertSection1Description")}
            </p>
            <DefaultButton
              className="text-base font-semibold leading-7 "
              title={t("expertSection1BtnText")}
            />
          </div>
        </div>
